...
var holidays = {
    ...
    dreikoenige:    {enabled: true,  "en": "Epiphany",            "de": "Heilige Drei Könige",          "ru": "День трёх Королей",                      desc: "religion",    date: "06.01", leap: false, offset: 6, comment_en: "(BW, BY, ST)", comment_de: "(BW, BY, ST)", comment_ru: "(BW, BY, ST)"},
    ...
    valentinstag:   {enabled: false, "en": "Valentine's Day",     "de": "Valentinstag",                 "ru": "Валенти́нов день",                        desc: "calender",    date: "14.02", offset: 45, leap: false},
    weltfrauentag:  {enabled: false, "en": "International Women's Day", "de": "Weltfrauentag",          "ru": "междунаро́дный же́нский день",             desc: "political",   date: "08.03", offset: 68, leap: true},
    ...
    walpurgisnacht: {enabled: false, "en": "Walpurgis Night",     "de": "Walpurgisnacht",               "ru": "???",                                    desc: "calender",    date: "30.04", offset: 120, leap: true},
    maifeiertag:    {enabled: true,  "en": "Labour Day",          "de": "Tag der Arbeit", "ru": "День Труда",                             desc: "political",   date: "01.05", offset: 121, leap: true},
    ...
    siebenschlaefer:{enabled: false, "en": "St Swtithin's Day",   "de": "Siebenschläfertag",            "ru": "сеногно́й",                               desc: "calender",    date: "27.06", offset: 178, leap: true},
    ...
    friedensfest:   {enabled: false, "en": "Peace Festival",      "de": "Friedensfest",                 "ru": "???",                                    desc: "religion",    date: "08.08", offset: 220, leap: true},
    ...
    michaelistag:   {enabled: false, "en": "Michaelmas",          "de": "Michaelistag",                 "ru": "???",                                    desc: "religion",    date: "29.09", offset: 272, leap: true},
    ...
    allerseelen:    {enabled: false, "en": "All Souls' Day",      "de": "Allerseelen",                  "ru": "День Всех Душ",                          desc: "religion",    date: "02.11", offset: 306, leap: true},
    martinstag:     {enabled: true,  "en": "Saint Martin's Day",  "de": "Martinstag",                   "ru": "???",                                    desc: "religion",    date: "11.11", offset: 315, leap: true},
    ...
    nikolaustag:    {enabled: true,  "en": "St Nicholas' Day",    "de": "Nikolaustag",                  "ru": "День Свято́го Никола́я",                   desc: "religion",    date: "06.12", offset: 340, leap: true},
